...
extension UIColor {
    ...
    static let customPurple = UIColor.rgb(red: 120, green: 87, blue: 194)
}
...
extension UIViewController{
    func showAlert(title: String, message: String){
        ...
        let cancel = UIAlertAction(title: "Cancel", style: .cancel) { (alertController) in
